...
iTest = 1000
mLossh1 = -np$load('mScores/mScores_h1_IndProdDCC_iT_6218_iTest_1000_vTGFinalXLEF_iP_0_p_0_qml_0_iTw_0_dRq_25_iS_16_vFinalXLEF.npy')
mLossh5 = -np$load('mScores/mScores_h5_IndProdDCC_iT_6218_iTest_1000_vTGFinalXLEF_iP_0_p_0_qml_0_iTw_0_dRq_25_iS_16_vFinalXLEF.npy')
...
for(q in 1:length(vQ)){
    ...
    sFileName = paste('MCSTables/RiskManXLEFLIndProd_MCSTable_',as.character(sStatistic),'_iK',as.character(iK),'_iTest', as.character(iTest),'_q', as.character(vQ[q]*100),'.xlsx',sep = "")
