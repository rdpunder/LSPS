...
install.packages(c("remotes", "devtools")) # version 2.5.0
...
# The following packages can be frozen by installing a Fortran compiler
...
#remotes::install_version("roll",           version = "1.1.6",  upgrade = "never")

# We install the current version
install.packages("randomForest") # version 4.7-1.1
install.packages("rugarch")      # version 1.4-9
install.packages("roll")         # version 1.1.6

## GitHub packages at exact versions
library(devtools)
install_github("cykbennie/fbi", ref = "v0.7.0", upgrade = "never")
install_github("gabrielrvsc/HDeconometrics") # version 0.1.0
