...
def main():    
    ...
    vH = vH = np.array([1,2,3])           # forecast horizons
    ...
    iMatrixSizeMax = 50
    lRq = [0.75, 0.80, 0.85, 0.90, 0.95, 0.975, 0.99] 
    ...
    # Weight function
    ####################
    dictW = {'fW': fWIndicatorR, 'vR': None,  'vParamsW': 0} 
    ...
    mRhat = np.load('mParamsDF/mRhat_' + sSettingsModels + '_bWarm_' + str(bWarm) + '.npy')
    ...
    mScoresProc = RollingScoresMPI(dictMethods, dictScores, dictW, lYh, lParamsDFh, mRhat, vIntScoresByProc, dictNumIntSettings, False)
