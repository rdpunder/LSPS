...
def main():    
    ...
    dictScores = {
              ...
              'CRPSGenFlatGammaEstim':{'fScore': CRPSGenFlatGammaFixed,'vParamsS': dictCRPSSettings, 'bWeighted': True, 'Label': 'CRPS$_{\\rm {gen}}^\\flat$'},
    ...
    # Weight function
    ####################
    dictW = {'fW': fWIndicatorTails, 'vR': None,  'vParamsW': dRTarget} #vR will be filled for different values of q
