...
### Output
* **Table 2** and **Table I.1**, last two weight functions of Sec. 4.1 panel,  **Table I.4**, and **Table I.5**, run  `MCSAnalysisRiskManIndProd.py` and `MCSAnalysisRiskManLogProd3.py`.
...
### Output
* **Table 2** and **Table I.1**, Sec. 4.2 panel, **Table I.6**, and **Table I.7**, run `03MCS/MCSAnalysisInflationCenter.py` and `03MCS/MCSAnalysisInflationTails.py`.
